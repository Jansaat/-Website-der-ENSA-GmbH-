    ...
    <main>
      <header className="site-header">
        <a className="brand" href="#start" aria-label="ENSA – das kreative Bauunternehmen, Startseite">
          <img className="ensa-logo" src="/ensa-logo-rot.png" alt="ENSA GmbH – Das kreative Bauunternehmen" />
        </a>
      ...
      <section className="contact" id="kontakt" aria-labelledby="contact-title">
        ...
        <div className="contact-grid">
          ...
          <a href="mailto:info@en-sa.de"><span>E-Mail</span><strong>info@en-sa.de</strong><small>Nachricht schreiben →</small></a>
      ...
      <footer>
        ...
        <details><summary>Impressum</summary><div className="legal"><p><strong>ENSA GmbH</strong><br />Alter Postweg 148<br />26670 Uplengen</p><p>Geschäftsführer: Hermann Saathoff<br />Telefon: 04956 40770<br />E-Mail: info@en-sa.de</p><p>Amtsgericht Leer<br />Handelsregister: HRB 111326</p></div></details>
